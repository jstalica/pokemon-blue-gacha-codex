  ...
  return (
    <div className="pity-meter" aria-label="Pity progress">
      <header className="pity-header">
        <h4>Pity Meter</h4>
        <span>Pulls until guaranteed Epic/Legendary</span>
      </header>
      <div className="pity-track">
        ...
        <div
          ...
          aria-valuemin={0}
          aria-valuemax={19}
          aria-valuenow={pity.pullsSinceEpic ?? 0}
        >
          <div
            className="pity-fill soft"
            style={{ width: `${softProgress * 100}%` }}
          />
        </div>
        <span className="pity-remaining">
          {softRemaining === 0 ? "Next pull" : `${softRemaining} pulls`}
        </span>
      </div>
      ...
      <div className="pity-track">
        ...
        <div
          ...
          aria-valuemin={0}
          aria-valuemax={49}
          aria-valuenow={pity.pullsSinceLegend ?? 0}
        >
          <div
            className="pity-fill hard"
            style={{ width: `${hardProgress * 100}%` }}
          />
        </div>
        <span className="pity-remaining">
          {hardRemaining === 0 ? "Next" : `${hardRemaining} pulls`}
        </span>
      </div>
    </div>
  );
